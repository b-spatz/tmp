# AvareX 0.68-based Android version
...
These are the changes I currently have in my version I've been using for weeks/months, and for expediency are retained here.
...
#### Feedback/Support
I welcome your feedback on the efficacy of these simple changes.  However, I can offer only limited support at this time.  I am only reluctantly making these available due to demand from the forum.  I'm not looking to create a rift in the AvareX community, but the modifications above are odesired by other AvareX users (per the forum), but not everyone has the time or inclination to tool up with Flutter and make code changes.  So I'm happy to share what I've been using for months to share the benefits.  I don't expect this sharing to be a long-term situation.  Blue Skies!
